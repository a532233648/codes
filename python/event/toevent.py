...
if __name__=='__main__':
	path="E:\\work\\event\\petrarch_win32\\example\\"
	txtfile="bbcnews.txt"
	...
	out.write("</Sentences>")
	out.close()
	#os.system('petrarch parse -i E:\\work\\event\\petrarch_win32\\example\\example2.xml -o E:\\work\\event\\petrarch_win32\\example\\out.txt')
	exepetrarch(xmlfile,path)
	#'petrarch parse -i E:\\work\\event\\petrarch_win32\\example\\example2.xml -o E:\\work\\event\\petrarch_win32\\example\\test_out.txt'